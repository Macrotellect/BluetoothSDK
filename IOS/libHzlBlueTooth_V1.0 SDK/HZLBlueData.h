...
@property   (nonatomic,assign)    int hardwareVersion;//硬件版本
@property   (nonatomic,assign)    int grind;//硬件版本
...
@property   (nonatomic,copy)    NSString *identifier;// 设备identifier(peripheral.identifier.UUIDString)
...
////
//@property   (nonatomic,copy)    NSString *prePackageStrForHzl;
