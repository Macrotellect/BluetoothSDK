...
typedef void(^Blue3OrBlue4DataBlock)(HZLBlueData *blueData,BlueType conBT,BOOL isFalseCon);
typedef void(^Blue3OrBlue4Connect)(NSString *markKey);
typedef void(^Blue3OrBlue4DisConnect)(NSString *markKey);
