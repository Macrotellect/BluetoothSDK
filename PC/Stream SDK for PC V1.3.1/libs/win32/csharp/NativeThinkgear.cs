...
namespace libStreamSDK
{
    public class NativeThinkgear
    {
        ...
        [DllImport(@"thinkgear.dll", EntryPoint = "BMD200_set8PacketMode", CallingConvention = CallingConvention.Cdecl)]
        public static extern int BMD200_set8PacketMode(int connectionId, int conOut4, int conOut3);

        [DllImport(@"thinkgear.dll", EntryPoint = "BMD200_set1PacketMode", CallingConvention = CallingConvention.Cdecl)]
